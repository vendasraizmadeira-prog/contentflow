  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      <div className="flex flex-col gap-3">
        {notifs.map(n => (
          <div key={n.id} className="rounded-2xl p-4 flex items-center gap-4" style={{ background: "#0F0F1E", border: "1px solid #22223A", opacity: n.active ? 1 : 0.5 }}>
            ...
            <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
              ...
              <div className="w-10 h-6 rounded-full peer transition-all" style={{ background: n.active ? "#D4FF3F" : "#22223A" }}>
      ...
      {showNew && (
        <div className="fixed inset-0 flex items-center justify-center z-50" style={{ background: "rgba(0,0,0,0.8)" }}>
          <div className="rounded-2xl p-6 w-full max-w-md mx-4" style={{ background: "#0F0F1E", border: "1px solid #22223A" }}>
            ...
            <div className="flex flex-col gap-4 mb-5">
              <div>
                ...
                <input value={form.title} onChange={e => setForm({ ...form, title: e.target.value })} placeholder="Ex: Post vai ao ar hoje" className="w-full px-4 py-3 rounded-xl text-sm outline-none" style={{ background: "#0B0B0F", border: "1px solid #22223A", color: "#fff" }}/>
              </div>
              <div>
              ...
              <div>
                ...
                <select value={form.client} onChange={e => setForm({ ...form, client: e.target.value })} className="w-full px-4 py-3 rounded-xl text-sm outline-none" style={{ background: "#0B0B0F", border: "1px solid #22223A", color: "#fff" }}>
            ...
            <div className="flex gap-3">
              <button onClick={() => setShowNew(false)} className="flex-1 py-2.5 rounded-xl text-sm" style={{ border: "1px solid #22223A" }}>Cancelar</button>
